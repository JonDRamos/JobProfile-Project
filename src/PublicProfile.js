...
function PublicProfile() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:3009/publicprofile/${userId}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3009/publiccert1/${userId}`)
    .then((response) => {
      console.log(response.data);
...
///////////////////////  DEGREE / CERTIFICACTION 2  //////////////////////////////////////////
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3009/publiccert2/${userId}`)
      .then((response) => {
        console.log(response.data);
...
const closeModalC = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3009/pubsocialmedia/${userId}`)
      .then((response) => {
...
useEffect(() => {
  ...
  axios.get(`http://localhost:3009/pubskills/${userId}`)
    .then((response) => {
...
useEffect(() => {
axios.get(`http://localhost:3009/publictesting/${userId}`)
  .then((response) => {
...
useEffect(() => {
  axios.get(`http://localhost:3009/publiceducation/${userId}`)
    .then((response) => {
      console.log(response.data);
...
useEffect(() => {
  axios.get(`http://localhost:3009/publicbootcamp/${userId}`)
    .then((response) => {
      console.log(response.data); 
 ...
 useEffect(() => {
  axios.get(`http://localhost:3009/publicproject1API/${userId}`)
  .then((response) => {
    console.log(response.data);
...
useEffect(() => {  axios.get(`http://localhost:3009/publicproject1skills/${userId}`)
    .then((response) => {
      const skillsData = response.data;
...
<div className="container-fluid p-0" style={{ overflowX: 'hidden', marginBottom: '0' }}>
  <div className="searchcontainer" style={{ height: '200PX', display: 'flex', flexDirection: 'column', background: 'white' }}>
